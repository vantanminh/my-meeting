...
public static class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> Vietnamese =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Preparing audio · {0}%"] = "Đang chuẩn bị âm thanh · {0}%",
            ["Uploading recording · {0}% of {1}"] = "Đang tải bản ghi lên · {0}% của {1}",
            ["AssemblyAI has queued the recording"] = "AssemblyAI đã xếp bản ghi vào hàng đợi",
            ["AssemblyAI is transcribing and separating speakers"] = "AssemblyAI đang chuyển lời và tách người nói",
            ["Checking the saved transcription job"] = "Đang kiểm tra phiên chuyển lời đã lưu",
            ["Writing the summary, decisions and action items"] = "Đang viết tóm tắt, quyết định và việc cần làm",
            ["Merging notes from every part"] = "Đang gộp ghi chú từ tất cả các phần",
            ["Summarized {0} of {1} parts"] = "Đã tóm tắt {0}/{1} phần",
            ["AssemblyAI is still transcribing this recording. The job is saved; retry in a few minutes to pick up the result."] = "AssemblyAI vẫn đang chuyển lời bản ghi này. Phiên xử lý đã được lưu; hãy thử lại sau vài phút để lấy kết quả.",
            ["AssemblyAI transcription failed."] = "AssemblyAI chuyển lời thất bại.",
            ["The recording audio is incomplete or unsupported. Your recording is still available; retry processing or record again."] = "Âm thanh bản ghi không đầy đủ hoặc không được hỗ trợ. Bản ghi vẫn còn; hãy thử xử lý lại hoặc ghi âm lại.",
            ["Processing was cancelled."] = "Đã hủy xử lý.",
            ["Recording"] = "Đang ghi âm",
            ["Ready"] = "Sẵn sàng",
            ["Stop recording"] = "Dừng ghi âm",
            ["Exit"] = "Thoát",
            ["Exit Meeting Assistant"] = "Thoát Meeting Assistant",
            ["Open Meeting Assistant"] = "Mở Meeting Assistant",
            ["Close"] = "Đóng",
            ["Add"] = "Thêm",
            ["Meeting ready"] = "Cuộc họp đã sẵn sàng",
            ["Still processing in the background"] = "Vẫn đang xử lý ở chế độ nền",
            ["Meeting Assistant keeps working in the notification area and will let you know when the meeting is ready."] = "Meeting Assistant tiếp tục chạy ở khay hệ thống và sẽ báo cho bạn khi cuộc họp xử lý xong.",
            ["You can close this window. Processing continues in the background and the tray icon shows progress."] = "Bạn có thể đóng cửa sổ này. Việc xử lý vẫn chạy nền và biểu tượng ở khay hệ thống sẽ hiển thị tiến độ.",
            ["A recording is still active. Stop and keep the audio before closing?"] = "Đang có một bản ghi âm. Dừng và giữ lại âm thanh trước khi đóng?",
            ["Processing is still running. Exit anyway? Processing stops, your audio stays on this device and you can retry later."] = "Việc xử lý vẫn đang chạy. Vẫn thoát? Việc xử lý sẽ dừng, âm thanh vẫn nằm trên máy này và bạn có thể thử lại sau.",
            ["Reset Meeting Assistant"] = "Đặt lại Meeting Assistant",
            ["ELAPSED"] = "ĐÃ CHẠY",
            ["Elapsed"] = "Thời gian đã chạy",
            ["Cancel processing"] = "Hủy xử lý",
            ["Nothing is running right now."] = "Hiện không có tác vụ nào đang chạy.",
            ["Start a recording here or with Ctrl + Shift + R."] = "Bắt đầu ghi âm tại đây hoặc bằng Ctrl + Shift + R.",
            ["Display size"] = "Kích thước hiển thị",
            ["Make text and controls larger or smaller. Shortcuts: Ctrl + plus, Ctrl + minus, Ctrl + 0."] = "Phóng to hoặc thu nhỏ chữ và nút bấm. Phím tắt: Ctrl + dấu cộng, Ctrl + dấu trừ, Ctrl + 0.",
            ["Smaller"] = "Nhỏ hơn",
            ["Larger"] = "Lớn hơn",
            ["Split turn"] = "Tách lượt nói",
            ["Merge with previous"] = "Gộp với lượt trước",
            ["Insert turn"] = "Chèn lượt nói",
            ["Delete turn"] = "Xóa lượt nói"
        };
