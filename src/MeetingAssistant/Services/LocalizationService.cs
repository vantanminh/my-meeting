...
public static class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> Vietnamese =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["recorded this week"] = "đã ghi tuần này",
            ["still open"] = "còn mở",
            ["Next steps"] = "Việc tiếp theo",
            ["Show archived"] = "Hiện bản lưu trữ",
            ["Copy visible"] = "Sao chép phần đang xem",
            ["Play"] = "Phát",
            ["Pause"] = "Tạm dừng",
            ["Split"] = "Tách",
            ["Merge"] = "Gộp",
            ...
            ["Minimize to the tray instead of exiting"] = "Thu nhỏ xuống khay thay vì thoát",
            ["Merge first two"] = "Gộp hai người đầu",
            ["Refresh summary"] = "Làm mới tóm tắt",
            ["Reveal audio folder"] = "Mở thư mục âm thanh",
            ...
            ["Dark"] = "Tối",
            ["Light"] = "Sáng",
            ["Dark or Light. The choice applies immediately and is saved on this device."] = "Tối hoặc Sáng. Lựa chọn có hiệu lực ngay và được lưu trên máy này.",
            ...
            ["Not configured · local demo will be used"] = "Chưa cấu hình · xử lý sẽ chờ API key",
            ["Not configured · processing waits for a key"] = "Chưa cấu hình · xử lý sẽ chờ API key",
            ...
            ["Next steps"] = "Việc tiếp theo",
            ["Open action items"] = "Việc còn mở",
            ["recorded this week"] = "đã ghi tuần này",
            ["still open"] = "còn mở",
            ["No meetings yet"] = "Chưa có cuộc họp",
            ["Start a recording, or clear the search if you were looking for a phrase."] = "Hãy bắt đầu ghi âm, hoặc xóa tìm kiếm nếu bạn đang lọc theo cụm từ.",
            ["Export"] = "Xuất",
            ["Archive"] = "Lưu trữ",
            ["Delete"] = "Xóa",
            ["Refresh summary"] = "Làm mới tóm tắt",
            ["AUDIO"] = "ÂM THANH",
            ["NOTES"] = "GHI CHÚ",
            ["Saved names"] = "Tên đã lưu",
            ["Names you save here are applied across transcripts. Voice matching is not enabled yet."] = "Tên bạn lưu ở đây được dùng cho các transcript. Chưa bật khớp giọng nói.",
            ["Update policy"] = "Chính sách cập nhật",
            ["Choose automatic install, ask first, or off."] = "Chọn cài tự động, hỏi trước, hoặc tắt.",
            ["Transcription language"] = "Ngôn ngữ chuyển lời",
            ["Hint the speech model, or leave auto."] = "Gợi ý ngôn ngữ cho model, hoặc để tự động.",
            ["Automatic updates are turned off."] = "Đã tắt cập nhật tự động.",
            ["Not synced yet"] = "Chưa đồng bộ",
            ["Last sync"] = "Đồng bộ gần nhất",
            ["WELCOME"] = "CHÀO MỪNG",
            ["Three things before your first recording"] = "Ba điều trước bản ghi đầu tiên",
            ["1. Capture stays on this device until you sync."] = "1. Bản ghi ở trên thiết bị này cho đến khi bạn đồng bộ.",
            ["2. Test your microphone so you know both sources work."] = "2. Hãy kiểm tra micro để chắc cả hai nguồn đều hoạt động.",
            ["3. Add an OpenAI key in Settings when you want a real transcript."] = "3. Thêm API key OpenAI trong Cài đặt khi bạn muốn transcript thật.",
            ["3. Add an AssemblyAI key for transcription and an OpenAI key for meeting notes."] = "3. Thêm API key AssemblyAI để chuyển lời và API key OpenAI để tạo ghi chú cuộc họp.",
            ["Processing recording..."] = "Đang xử lý bản ghi...",
            ["Transcribing meeting..."] = "Đang chuyển cuộc họp thành văn bản...",
            ["Generating meeting notes..."] = "Đang tạo ghi chú cuộc họp...",
            ["Unable to process this meeting."] = "Không thể xử lý cuộc họp này.",
            ["Unable to process this meeting"] = "Không thể xử lý cuộc họp này",
            ["Retry"] = "Thử lại",
            ["AssemblyAI API key"] = "API key AssemblyAI",
            ["AssemblyAI key not configured"] = "Chưa cấu hình API key AssemblyAI",
            ["Add an AssemblyAI API key to transcribe this recording. Your audio is still saved locally."] = "Hãy thêm API key AssemblyAI để chuyển lời. Bản ghi vẫn được lưu cục bộ.",
            ["Add an OpenAI API key in Settings to generate meeting notes. The transcript is saved."] = "Hãy thêm API key OpenAI trong Cài đặt để tạo ghi chú. Transcript đã được lưu.",
            ["The meeting notes were not in the expected format. The transcript is saved; retry to generate notes."] = "Ghi chú cuộc họp không đúng định dạng. Transcript đã được lưu; hãy thử lại để tạo ghi chú.",
            ["The meeting notes were cut off before they could be saved. The transcript is saved; retry to generate notes."] = "Ghi chú cuộc họp bị cắt trước khi lưu. Transcript đã được lưu; hãy thử lại để tạo ghi chú.",
            ["AssemblyAI rejected the API key. Check the key in Settings and retry."] = "AssemblyAI từ chối API key. Hãy kiểm tra key trong Cài đặt rồi thử lại.",
            ["AssemblyAI is rate limiting requests. Wait a moment and retry."] = "AssemblyAI đang giới hạn số lần gọi. Hãy đợi một lát rồi thử lại.",
            ["AssemblyAI is not reachable. Check the network and try again."] = "Không thể kết nối AssemblyAI. Hãy kiểm tra mạng và thử lại.",
            ["AssemblyAI took too long to respond. Retry processing."] = "AssemblyAI phản hồi quá lâu. Hãy xử lý lại.",
            ["AssemblyAI did not return any transcript text."] = "AssemblyAI không trả về nội dung transcript.",
            ["The recording audio could not be read. Your recording is still available; retry processing or record again."] = "Không đọc được file âm thanh. Bản ghi vẫn còn; hãy xử lý lại hoặc ghi cuộc họp mới.",
            ["No usable recording audio was found. Your recording is still available; record a new meeting and retry."] = "Không tìm thấy âm thanh dùng được. Bản ghi vẫn còn; hãy ghi cuộc họp mới rồi xử lý lại.",
            ["This meeting was deleted while it was processing."] = "Cuộc họp đã bị xóa trong lúc xử lý.",
            ["OpenAI could not generate meeting notes. The transcript is saved; retry to generate notes."] = "OpenAI không tạo được ghi chú. Transcript đã được lưu; hãy thử lại.",
            ["OpenAI is not reachable. The transcript is saved; retry to generate notes."] = "Không thể kết nối OpenAI. Transcript đã được lưu; hãy thử lại để tạo ghi chú.",
            ["OpenAI took too long to respond. The transcript is saved; retry to generate notes."] = "OpenAI phản hồi quá lâu. Transcript đã được lưu; hãy thử lại để tạo ghi chú.",
            ["OpenAI rejected the API key. The transcript is saved; check the key in Settings and retry."] = "OpenAI từ chối API key. Transcript đã được lưu; hãy kiểm tra key rồi thử lại.",
            ["AssemblyAI key removed from this Windows profile"] = "Đã xóa API key AssemblyAI khỏi hồ sơ Windows này",
            ["Skip"] = "Bỏ qua",
            ["Got it"] = "Đã hiểu",
            ["Add an OpenAI API key in Settings to transcribe this recording. Your audio is still saved locally."] = "Hãy thêm API key OpenAI trong Cài đặt để chuyển lời. Bản ghi vẫn được lưu cục bộ.",
            ["Meeting deleted from this workspace"] = "Đã xóa cuộc họp khỏi workspace",
            ["Meeting archived"] = "Đã lưu trữ cuộc họp",
            ["Meeting restored"] = "Đã khôi phục cuộc họp",
            ["Meeting exported"] = "Đã xuất cuộc họp",
            ["Recording continues in the background"] = "Việc ghi âm vẫn tiếp tục ở chế độ nền",
            ["Waiting to process"] = "Đang chờ xử lý",
            ["Transcribing"] = "Đang chuyển lời nói",
            ["Writing notes"] = "Đang viết ghi chú",
            ["Needs retry"] = "Cần xử lý lại",
            ["Processing"] = "Đang xử lý",
            ["Recording"] = "Đang ghi",
            ["Ready"] = "Sẵn sàng",
            ["Archived"] = "Đã lưu trữ",
            ["Recording saved"] = "Đã lưu bản ghi",
            ["Audio prepared"] = "Đã chuẩn bị âm thanh",
            ["Uploading recording"] = "Đang tải bản ghi lên",
            ["Uploading and transcribing"] = "Đang tải lên và chuyển lời",
            ["Transcript saved"] = "Đã lưu transcript",
            ["Writing meeting notes"] = "Đang viết ghi chú cuộc họp",
            ["Meeting saved"] = "Đã lưu cuộc họp",
            ["The audio files are on this computer. Preparing them for transcription."] = "File âm thanh đã ở trên máy này. Đang chuẩn bị để chuyển lời.",
            ["Microphone and system audio are mixed. Uploading the recording."] = "Đã trộn micro và âm thanh hệ thống. Đang tải bản ghi lên.",
            ["Sending the finished recording. Transcription starts after the upload, not while you were talking."] = "Đang gửi bản ghi đã hoàn tất. Việc chuyển lời bắt đầu sau khi tải lên, không phải trong lúc bạn đang nói.",
            ["Transcription is running. Speaker labels and timestamps are added when it finishes."] = "Đang chuyển lời. Nhãn người nói và mốc thời gian sẽ có khi hoàn tất.",
            ["Speaker turns are saved. Writing the meeting notes next."] = "Các lượt nói đã được lưu. Tiếp theo là viết ghi chú cuộc họp.",
            ["Creating the overview, key points, decisions, action items, and open questions from the transcript."] = "Đang tạo tổng quan, điểm chính, quyết định, việc cần làm và câu hỏi còn mở từ transcript.",
            ["The transcript and meeting notes are stored on this computer."] = "Transcript và ghi chú cuộc họp đã được lưu trên máy này.",
            ["The transcript and meeting notes are already stored on this computer."] = "Transcript và ghi chú cuộc họp đã có sẵn trên máy này.",
            ["Scan recordings"] = "Quét bản ghi",
            ["Processing continues in the background. You can start another recording."] = "Xử lý tiếp tục ở nền. Bạn có thể ghi cuộc họp mới ngay.",
            ["The recording audio is no longer on this computer."] = "File âm thanh không còn trên máy này.",
            ["Processing stopped before it finished. The recording is still saved. Retry to continue."] = "Xử lý bị dừng trước khi xong. Bản ghi vẫn còn. Hãy thử lại để tiếp tục.",
            ["Found 1 saved recording that can be processed again."] = "Đã tìm thấy 1 bản ghi có thể xử lý lại.",
            ["Found saved recordings that can be processed again."] = "Đã tìm thấy các bản ghi có thể xử lý lại.",
            ["No extra recordings were found. Every saved audio folder is already in the list."] = "Không thấy bản ghi thừa. Mọi thư mục âm thanh đã có trong danh sách.",
            ["Processing paused. The recording stays on this computer and can be retried."] = "Đã tạm dừng xử lý. Bản ghi vẫn ở trên máy này và có thể xử lý lại.",
            ["A recording is still active. Stop and keep the audio before closing?"] = "Bản ghi vẫn đang chạy. Dừng và giữ âm thanh trước khi đóng?",
            ["Processing is still running. Close anyway? The recording stays on this computer and you can process it again from the meeting list."] = "Xử lý vẫn đang chạy. Vẫn đóng? Bản ghi ở trên máy này và bạn có thể xử lý lại từ danh sách cuộc họp.",
            ["The transcript is saved. Meeting notes have not been written yet."] = "Transcript đã được lưu. Ghi chú cuộc họp chưa được viết.",
            ["Meeting notes appear here after the recording is processed."] = "Ghi chú cuộc họp hiện ở đây sau khi bản ghi được xử lý.",
            ["key points"] = "điểm chính",
            ["decisions"] = "quyết định",
            ["action items"] = "việc cần làm",
            ["open questions"] = "câu hỏi còn mở",
            ["PROCESSING"] = "ĐANG XỬ LÝ",
            ["PROCESSING IN THE BACKGROUND"] = "ĐANG XỬ LÝ Ở NỀN",
            ["WAITING TO PROCESS"] = "ĐANG CHỜ XỬ LÝ",
            ["This recording is saved and waiting for its turn. You can start another recording."] = "Bản ghi đã được lưu và đang chờ lượt. Bạn có thể bắt đầu ghi cuộc họp khác.",
            ["View progress"] = "Xem tiến trình",
            ["Elapsed"] = "Đã chạy",
            ["Processing continues while you record. Open the meeting after this recording stops."] = "Xử lý vẫn chạy trong lúc bạn ghi âm. Hãy mở cuộc họp sau khi dừng bản ghi này.",
            ["Meeting ready. The transcript and notes are saved on this computer."] = "Cuộc họp đã sẵn sàng. Transcript và ghi chú được lưu trên máy này.",
            ["This meeting needs another try. The recording is still saved."] = "Cuộc họp này cần thử lại. Bản ghi vẫn còn.",
            ["Processing was cancelled."] = "Đã hủy xử lý."
        };
